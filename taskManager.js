...
const addTodoTask = document.getElementById('addTodoTask')
const addProgressTask = document.getElementById('addProgressTask')
const addReviewTask = document.getElementById('addReviewTask')
const addDoneTask = document.getElementById('addDoneTask')
